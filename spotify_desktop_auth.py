...
KEYRING_SERVICE = "Spotify Artist Auto-Follow"
...
class KeyringCacheHandler(CacheHandler):
    ...
    def get_cached_token(self):
        try:
            value = self.keyring.get_password(KEYRING_SERVICE, self.account)
    ...
    def clear(self):
        try:
            self.keyring.delete_password(KEYRING_SERVICE, self.account)
            return True
